...
public:
  ...
  public:
    // Getters and Setters
    [[nodiscard]] const std::string &get_interrupted_feeding_rate_raster() const {
      return interrupted_feeding_rate_raster_;
    }
    void set_interrupted_feeding_rate_raster(const std::string &value) {
      interrupted_feeding_rate_raster_ = value;
    }
  ...
  public:
    // Getters and Setters
    [[nodiscard]] const std::vector<double> &get_interrupted_feeding_rate() const {
      return interrupted_feeding_rate_;
    }
    void set_interrupted_feeding_rate(const std::vector<double> &value) {
      interrupted_feeding_rate_ = value;
    }
  ...
  [[nodiscard]] bool get_within_host_induced_free_recombination() const {
    return within_host_induced_free_recombination_;
  }
  void set_within_host_induced_free_recombination(bool value) {
...
struct convert<MosquitoParameters::GridBased> {
  ...
  static bool decode(const Node &node, MosquitoParameters::GridBased &rhs) {
    ...
    rhs.set_interrupted_feeding_rate_raster(
        node["interrupted_feeding_rate_raster"].as<std::string>());
