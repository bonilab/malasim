...
public:
    ...
    [[nodiscard]] const std::vector<std::array<double, 21>> &get_age_distribution_by_location() const {
        return age_distribution_by_location_;
    }
    void set_age_distribution_by_location(const std::vector<std::array<double, 21>> &value) {
...
private:
    ...
    double cell_size_;
    std::vector<std::array<double, 21>> age_distribution_by_location_;
};
...
public:
    ...
    // Getters and Setters for p_treatment_for_less_than_5_by_location
    [[nodiscard]] const std::vector<double> &get_p_treatment_for_less_than_5_by_location() const {
        return p_treatment_for_less_than_5_by_location_;
    }
    void set_p_treatment_for_less_than_5_by_location(const std::vector<double> &value) {
        p_treatment_for_less_than_5_by_location_ = value;
    }

    // Getters and Setters for p_treatment_for_more_than_5_by_location
    [[nodiscard]] const std::vector<double> &get_p_treatment_for_more_than_5_by_location() const {
        return p_treatment_for_more_than_5_by_location_;
    }
    void set_p_treatment_for_more_than_5_by_location(const std::vector<double> &value) {
        p_treatment_for_more_than_5_by_location_ = value;
    }
...
private:
    ...
    std::vector<std::array<double, 21>> age_distribution_by_location_;
    std::vector<double> p_treatment_for_less_than_5_by_location_;
    std::vector<double> p_treatment_for_more_than_5_by_location_;
    std::vector<double> beta_by_location_;
...
struct YAML::convert<GridBased> {
    ...
    static bool decode(const Node &node, GridBased &rhs) {
        ...
        rhs.set_age_distribution_by_location(node["age_distribution_by_location"].as<std::vector<std::array<double, 21>>>());
        return true;
    }
};
...
struct YAML::convert<LocationInfo> {
    ...
    static bool decode(const Node &node, LocationInfo &rhs) {
...
struct YAML::convert<LocationBased> {
    static Node encode(const LocationBased &rhs) {
        ...
        node["age_distribution_by_location"] = rhs.get_age_distribution_by_location();
        node["p_treatment_for_less_than_5_by_location"] = rhs.get_p_treatment_for_less_than_5_by_location();
        node["p_treatment_for_more_than_5_by_location"] = rhs.get_p_treatment_for_more_than_5_by_location();
        node["beta_by_location"] = rhs.get_beta_by_location();
        node["population_size_by_location"] = rhs.get_population_size_by_location();
        return node;
    }

    static bool decode(const Node &node, LocationBased &rhs) {
        if (!node["location_info"] || !node["age_distribution_by_location"] ||
            !node["p_treatment_for_less_than_5_by_location"] || !node["p_treatment_for_more_than_5_by_location"] ||
        ...
        rhs.set_location_info(node["location_info"].as<std::vector<LocationInfo>>());
        rhs.set_age_distribution_by_location(node["age_distribution_by_location"].as<std::vector<std::array<double, 21>>>());
        rhs.set_p_treatment_for_less_than_5_by_location(node["p_treatment_for_less_than_5_by_location"].as<std::vector<double>>());
        rhs.set_p_treatment_for_more_than_5_by_location(node["p_treatment_for_more_than_5_by_location"].as<std::vector<double>>());
        rhs.set_beta_by_location(node["beta_by_location"].as<std::vector<double>>());
