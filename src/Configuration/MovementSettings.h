...
struct convert<BarabasiSettings> {
    ...
    static bool decode(const Node& node, BarabasiSettings& rhs) {
...
struct convert<WesolowskiSettings> {
    ...
    static bool decode(const Node& node, WesolowskiSettings& rhs) {
...
struct convert<MovingLevelDistributionGamma> {
    ...
    static bool decode(const Node& node, MovingLevelDistributionGamma& rhs) {
...
struct convert<CirculationInfo> {
    ...
    static bool decode(const Node& node, CirculationInfo& rhs) {
        ...
        rhs.set_moving_level_distribution(node["moving_level_distribution"].as<MovingLevelDistribution>());
        rhs.set_circulation_percent(node["circulation_percent"].as<double>());
        rhs.set_length_of_stay(node["length_of_stay"].as<MovingLevelDistributionGamma>());
        return true;
    }
};
...
struct convert<MovementSettings> {
    ...
    static bool decode(const Node& node, MovementSettings& rhs) {
        ...
        rhs.set_spatial_model(node["spatial_model"].as<SpatialModel>());
        rhs.set_circulation_info(node["circulation_info"].as<CirculationInfo>());
        return true;
    }
};
}
