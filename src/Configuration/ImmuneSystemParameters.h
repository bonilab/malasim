...
public:
    ...
    void set_immune_effect_on_progression_to_clinical(const double value) { immune_effect_on_progression_to_clinical_ = value; }
    ...
    void set_factor_effect_age_mature_immunity(const double value) { factor_effect_age_mature_immunity_ = value; }
  ...
  void process_config_with_parasite_density(const double log_parasite_density_asymptomatic, const double log_parasite_density_cured) {
