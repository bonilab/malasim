...
public:
  ...
  SQLiteDistrictReporter(const SQLiteDistrictReporter &) = delete;
  SQLiteDistrictReporter(SQLiteDistrictReporter &&) = delete;
  SQLiteDistrictReporter &operator=(SQLiteDistrictReporter &&) = delete;
